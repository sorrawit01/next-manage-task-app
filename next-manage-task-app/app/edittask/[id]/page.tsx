...
export default async function Page() {
    ...
    const [old_image_url, setOld_image_url] = useState<string>('');


    // ดึงข้อมูลจาก supabase มาแสดงที่หน้าจอตาม id ที่ได้จาก url
    useEffect(() => {
        async function fetchData() {
            ...
            setpreview_file(data.image_url);
    ...
    // ลบรูปเก่าออกจาก Storage (ถ้ามีรูปเก่า)
    if (image_url) {
        const image_name = old_image_url?.split("/").pop() as string;
